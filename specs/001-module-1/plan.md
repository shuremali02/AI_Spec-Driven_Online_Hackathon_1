...
**Input:**
- Spec: `specs/001-module-1/spec.md` (relevant Chapter 1 section)

**Step 2.1: Plan Chapter Structure**
```bash
claude code --skill chapter-outliner \
  --input "Read specs/001-module-1/spec.md (Chapter 1 section)" \
...
claude code --agent tech_writer \
  --spec specs/001-module-1/spec.md (Chapter 1 section) \
...
**Input:**
- Spec: `specs/001-module-1/spec.md` (relevant Chapter 2 section)
- Reference: Chapter 1 (already completed)

**Step 3.1: Generate Content**
```bash
claude code --agent tech_writer \
  --spec specs/001-module-1/spec.md (Chapter 2 section) \
